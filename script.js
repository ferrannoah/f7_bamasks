...
var nodes = [115, 130, 142, 154, 178, 190, 202, 214, 226, 238, 250, 262, 274, 286, 298, 310, 322, 334, 346, 358, 370, 382, 394, 406, 430, 442, 454, 466, 478, 490, 502, 526] // 514 418
var allNodes = []
...
var v1 = new bar([262], [478], "v1", 10);
var v2 = new bar([274], [490], "v2", 25);
var v3 = new bar([286], [502], "v3", 25);

var h3 = new bar([298], [298], "h3", 30);
var h4 = new bar([310], [310], "h4", 30);
var h5 = new bar([322], [322], "h5", 30);
var h6 = new bar([334], [334], "h6", 30);
var h7 = new bar([346], [346], "h7", 30);

var vn = new bar([406], [406], "vn", 80, null, [], []); //nose

var l1 = new bar([370], [370], "l1", 25, [[v1, vn], h6], [v2], [v2]);
var l2 = new bar([382], [382], "l2", 25, [[v1, vn], h4], [v3, v2], [v3, v2]);
var l3 = new bar([394], [394], "l3", 25, [[v1, vn], h3], [], []); // open 0

var b3 = new bar([190],[190], "b3", 0, null,[],[]); // HD

var d1 = new bar([430], [430], "d1", 25, [[v1, vn]], [l2, v2], [l2, v2]);
var d2 = new bar([442], [442], "d2", 25, [[v1, vn], b3], [v2, v3, l2, l3], [v2, v3, l2, l3]); // \\//
var d3 = new bar([454], [454], "d3", 25, [[v1, vn], b3], [v2, v3, l2, l3], [v2, v3, l2, l3]);
var d4 = new bar([466], [466], "d4", 25, [[v1, vn]], [l1, l2, l3], [l1, l2]);
...
var e3 = new bar([526],[226], "e3", 10, [b3]); // OPEN
var e4 = new bar([238],[238], "e4", 35, [b3]); // BECK ag 0

e1.addTogNodes([[e1, e2, e3, e4], [e1, e2, e3, e4]])
var beck = new bar([178],[178], "beck", 135, null, [d4], [] ) // 178 Frame Riser
var bull = new bar([358],[142], "bull", 35, null, [l2, v3, d2, d3, vn], [l2, v3, d1, d2, d3, vn]); // Open Bull
